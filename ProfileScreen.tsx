...
export default function ProfileScreen() {
  ...
  {/* SPRINT 2 - Puntaje de confianza (trustScore)
      Este número sube o baja automáticamente según las votaciones:
      +10 puntos → cuando un vecino confirma tu alerta
      -5  puntos → cuando un vecino la marca como dudosa
      +15 puntos → bonus cuando tu alerta llega a 3 confirmaciones
      -20 puntos → penalización cuando tu alerta llega a 3 dudosos */}
